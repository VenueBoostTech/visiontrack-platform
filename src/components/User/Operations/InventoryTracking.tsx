...
const mockData = {
  stockLevels: [
    { category: 'Electronics', inStock: 452, lowStock: 28, outOfStock: 12, threshold: 15 },
    { category: 'Clothing', inStock: 834, lowStock: 45, outOfStock: 8, threshold: 20 },
    { category: 'Home Goods', inStock: 623, lowStock: 32, outOfStock: 5, threshold: 25 },
    { category: 'Groceries', inStock: 1245, lowStock: 67, outOfStock: 15, threshold: 30 }
  ],
  inventoryAlerts: [
    { id: 1, type: 'Low Stock', product: 'Wireless Earbuds', location: 'Electronics A3', severity: 'high' },
    { id: 2, type: 'Theft Alert', product: 'Designer Watches', location: 'Accessories B2', severity: 'critical' },
    { id: 3, type: 'Restock Need', product: 'Organic Produce', location: 'Grocery F5', severity: 'medium' },
    { id: 4, type: 'Misplaced', product: 'Winter Jackets', location: 'Clothing C1', severity: 'low' }
  ],
...
export default function InventoryTracking() {
  ...
  const totalProducts = mockData.stockLevels.reduce((acc, curr) => 
    acc + curr.inStock + curr.lowStock + curr.outOfStock, 0
  );
                ...
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">
                      {category.inStock + category.lowStock + category.outOfStock} total items
                    </p>
                  </div>
                  <span className={`px-2 py-1 text-xs rounded-full ${
                    ...
                    {((category.inStock / (category.inStock + category.lowStock + category.outOfStock)) * 100).toFixed(1)}% in stock
                  </span>
                </div>
          ...
          <div className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={mockData.placementEffectiveness}>
                ...
                <Bar dataKey="visibility" name="Visibility Score" fill="#10b981" />
