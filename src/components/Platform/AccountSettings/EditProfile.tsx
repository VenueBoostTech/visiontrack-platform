...
export default function EditProfile() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const updatedUser = await updateUserProfile(data, uploadedImageUrl as string);
  ...
  const imageToShow = data.profilePhoto || session?.user?.image;
      ...
      <Card>
        ...
        <div>
          <div className="relative mb-9 flex items-center gap-8">
            ...
            {!file && (
              <p>
                Recommended size: 300px X 300px <br /> 
