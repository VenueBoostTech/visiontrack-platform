...
export default function CamerasContent() {
  ...
  const filterCount = Object.keys(filter).reduce((sum, i) => filter[i] ? sum + 1 : sum, 0);
      ...
      <div className="bg-white rounded-lg shadow-sm dark:bg-gray-800">
        <div className="p-6 border-b dark:border-gray-700">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-2xl text-gray-700 font-bold">Cameras</h2>
        ...
        <div className="p-4 border-b dark:border-gray-700">
          <div className="flex gap-4">
            <div className="flex-1 relative">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  e.target.value ? newFilter.name = e.target.value : delete newFilter.name
                  setFilter(newFilter)
                }}
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 border rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 relative"
            >
              <div className="relative">
                <Filter className="w-5 h-5" />
                {filterCount > 0 && (
                  <span className="absolute top-[-4px] right-[-4px] inline-block w-3 h-3 text-[8px] text-white bg-red-500 rounded-full flex items-center justify-center">
                ...
                cameras.map((camera) => (
                  <tr key={camera.id} className="border-t dark:border-gray-700">
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-2 py-1 rounded-full text-xs ${camera.status === "ACTIVE"
